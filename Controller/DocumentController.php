...
{
    const NAMESPACED_CLASS = 'Tec\Ayt\CoreBundle\Entity\Document';
    const NAMESPACED_FORM_TYPE = 'Tec\Ayt\AdminBundle\Form\Type\DocumentType';
    ...
    public function listAction()
    {
        ...
        return $this->render('TecAytAdminBundle:Document:list.html.twig', array(
            'documents' => $documents
        ));
    }
    ...
    public function processAction(Request $request, $id)
    {
        ...
        $document = $this->getDoctrine()->getRepository(self::NAMESPACED_CLASS)->find($id);
        ...
        $form = $this->createForm(new $formType(), $document, $options);
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect(
                $this->generateUrl('tec_ayt_admin_document_list')
            );
        }

        // Render as new Entity
        return $this->render('TecAytAdminBundle:Document:form.html.twig', array(
    ...
    {
        /** @var Document $document */
        $document = $this->getDoctrine()->getRepository(self::NAMESPACED_CLASS)
            ->find($id);
    ...
    public function viewAction($id)
    {
        ...
        $repository = $this->getDoctrine()->getRepository(self::NAMESPACED_CLASS);
        /** @var Document $document */
        $document = $repository->find($document);
        ...
        return $this->render('TecAytAdminBundle:Document:view.html.twig');
    }
    ...
    public function downloadAction($id)
    {
        ...
        $response = $this->generateDownloadResponse($document);
        return $response;
    }
